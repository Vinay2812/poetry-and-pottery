...
export function AddressCard({
  ...
  return (
    <div
      ...
      className={cn(
        "border-border bg-card relative flex min-h-[130px] flex-col overflow-hidden rounded-2xl border p-4 transition-all duration-200",
        onSelect && "hover:bg-cream cursor-pointer",
