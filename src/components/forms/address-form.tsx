...
export function AddressForm({
  ...
  const inputClassName =
    "h-12 rounded-xl border-border bg-cream px-4 text-base transition-all focus:border-primary focus:bg-cream focus:ring-2 focus:ring-primary/20";
          ...
          render={({ field }) => (
            ...
            >
              <SelectTrigger
                id="state"
                className={cn(
                  "focus:border-primary focus:ring-primary/20 focus:bg-cream border-border bg-cream h-12 w-full rounded-xl px-4 text-base transition-all focus:ring-2",
