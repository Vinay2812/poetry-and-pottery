...
const inputStyles =
  "h-10 w-full rounded-lg border border-border bg-cream px-3.5 text-sm transition-colors duration-150 placeholder:text-muted-foreground hover:border-neutral-400 focus:border-primary focus:ring-3 focus:ring-primary/10 focus:outline-none disabled:cursor-not-allowed disabled:opacity-50 appearance-none";
