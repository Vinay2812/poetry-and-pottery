      ...
      <div className="container mx-auto px-4 py-6 lg:px-8">
        ...
        <div className="grid gap-8 lg:grid-cols-3">
          ...
          <div className="hidden lg:block">
            <div className="shadow-soft bg-card border-border space-y-6 rounded-2xl border p-6">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="space-y-4">
              ...
              {[1, 2, 3].map((i) => (
                <div
                  key={i}
                  className="shadow-soft bg-card border-border flex gap-4 rounded-2xl border p-4"
                >
