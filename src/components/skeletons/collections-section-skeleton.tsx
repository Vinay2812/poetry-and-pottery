  ...
  return (
    <section className={cn("relative", className)}>
      ...
      <div className="grid gap-4 lg:grid-cols-[1fr_1fr] lg:gap-6">
        ...
        <div className="shadow-soft bg-card border-border flex flex-col overflow-hidden rounded-2xl border">
        ...
        <div className="flex flex-col gap-3">
          {Array.from({ length: 4 }).map((_, i) => (
            <div
              key={i}
              className="shadow-soft bg-card border-border flex items-center gap-4 rounded-xl border p-3"
            >
