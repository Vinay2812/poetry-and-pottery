        ...
        <div className="container mx-auto px-4 lg:px-8">
          ...
          <div className="mx-auto max-w-3xl">
                      ...
                      {category.faqs.map((faq, index) => {
                        ...
                        return (
                          <AccordionItem
                            ...
                            className="shadow-soft hover:shadow-card bg-card border-border mb-3 overflow-hidden rounded-xl border transition-shadow"
                          >
            ...
            <div className="mb-8">
              ...
              <div className="shadow-soft bg-card border-border grid gap-4 rounded-2xl border p-5 sm:grid-cols-3 lg:p-6">
