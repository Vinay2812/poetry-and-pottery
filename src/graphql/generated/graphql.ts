...
export type DeleteAddressMutation = {
  deleteAddress: { success: boolean; error?: string | null };
};
...
export type AdminDashboardStatsQuery = {
  adminDashboardStats: {
    ...
    events: { total: number; upcoming: number; upcomingIn7Days: number };
    users: { total: number; newThisMonth: number };
    revenue: { totalOrders: number; totalRegistrations: number };
    newsletter: { totalSubscribers: number; newThisMonth: number };
  };
};
...
export type AdminRecentOrdersQuery = {
  adminRecentOrders: Array<{
    id: string;
    status: string;
    total: number;
...
export type AdminRecentRegistrationsQuery = {
  adminRecentRegistrations: Array<{
    id: string;
    status: string;
...
export type AdminLowStockProductsQuery = {
  adminLowStockProducts: Array<{
    id: number;
    name: string;
    slug: string;
...
export type AdminUpcomingEventsQuery = {
  adminUpcomingEvents: Array<{
    id: string;
    title: string;
    slug: string;
...
export type AdminNewsletterSubscribersQuery = {
  adminNewsletterSubscribers: Array<{
    id: number;
    email: string;
    name?: string | null;
    image?: string | null;
...
export type AdminUpdateCategoryIconMutation = {
  adminUpdateCategoryIcon: { success: boolean; error?: string | null };
};
...
export type AdminAddCategoryMutation = {
  adminAddCategory: { success: boolean; error?: string | null };
};
...
export type AdminRenameCategoryMutation = {
  adminRenameCategory: { success: boolean; error?: string | null };
};
...
export type AdminDeleteCategoryMutation = {
  adminDeleteCategory: { success: boolean; error?: string | null };
};
...
export type AdminCategoriesQuery = {
  adminCategories: {
    total: number;
    categories: Array<{ name: string; icon: string; productCount: number }>;
  };
};

export type AdminAllConfiguredCategoriesQueryVariables = Exact<{
  [key: string]: never;
}>;

export type AdminAllConfiguredCategoriesQuery = {
  adminAllConfiguredCategories: Array<{ name: string; icon: string }>;
};

export type AdminAvailableIconsQueryVariables = Exact<{ [key: string]: never }>;

export type AdminAvailableIconsQuery = {
  adminAvailableIcons: Array<{ value: string; label: string }>;
};
...
export type AdminUpdateContentPageMutation = {
  adminUpdateContentPage: { success: boolean; error?: string | null };
};
...
export type AdminToggleContentPageActiveMutation = {
  adminToggleContentPageActive: { success: boolean; error?: string | null };
};

export type AdminContentPagesQueryVariables = Exact<{ [key: string]: never }>;

export type AdminContentPagesQuery = {
  adminContentPages: Array<{
    slug: string;
    title: string;
    is_active: boolean;
...
export type AdminContentPageBySlugQuery = {
  adminContentPageBySlug?: {
    id: number;
    slug: string;
    title: string;
    content: any;
...
export type AdminUpdateEventStatusMutation = {
...
export type AdminDeleteEventReviewMutation = {
...
export type AdminEventByIdQuery = {
  adminEventById?: {
    id: string;
    title: string;
    slug: string;
...
export type AdminEventRegistrationsQuery = {
...
export type AdminEventReviewsQuery = {
  adminEventReviews: {
    total: number;
...
export type AdminEventStatusOptionsQueryVariables = Exact<{
  [key: string]: never;
}>;

export type AdminEventStatusOptionsQuery = {
  adminEventStatusOptions: Array<{ value: string; label: string }>;
};

export type AdminEventLevelOptionsQueryVariables = Exact<{
  [key: string]: never;
}>;

export type AdminEventLevelOptionsQuery = {
  adminEventLevelOptions: Array<{ value: string; label: string }>;
};
...
export type AdminUpdateOrderStatusMutation = {
  adminUpdateOrderStatus: { success: boolean; error?: string | null };
};
...
export type AdminUpdateOrderPriceMutation = {
  adminUpdateOrderPrice: { success: boolean; error?: string | null };
};
...
export type AdminUpdateOrderDiscountMutation = {
  adminUpdateOrderDiscount: { success: boolean; error?: string | null };
};
...
export type AdminUpdateOrderItemDiscountMutation = {
  adminUpdateOrderItemDiscount: { success: boolean; error?: string | null };
};
...
export type AdminUpdateOrderItemQuantityMutation = {
  adminUpdateOrderItemQuantity: { success: boolean; error?: string | null };
};
...
export type AdminUpdateProductMutation = {
  adminUpdateProduct: { success: boolean; error?: string | null };
};
...
export type AdminDeleteProductMutation = {
  adminDeleteProduct: { success: boolean; error?: string | null };
};
...
export type AdminToggleProductActiveMutation = {
  adminToggleProductActive: { success: boolean; error?: string | null };
};
...
export type AdminDeleteProductReviewMutation = {
  adminDeleteProductReview: { success: boolean; error?: string | null };
};
...
export type AdminProductsQuery = {
  adminProducts: {
    ...
    products: Array<{
      ...
      image_urls: Array<string>;
      created_at: Date | string;
      _count: { reviews: number; wishlists: number; carts: number };
    }>;
  };
};
...
export type AdminProductReviewsQuery = {
  adminProductReviews: {
    total: number;
    averageRating: number;
    reviews: Array<{
...
export type PublicAboutContentQuery = {
  publicAboutContent?: {
    storyTitle: string;
    storySubtitle: string;
    storyContent: Array<string>;
...
export type PublicFaqContentQuery = {
  publicFAQContent?: {
    categories: Array<{
      title: string;
...
export type PublicShippingContentQueryVariables = Exact<{
  [key: string]: never;
}>;

export type PublicShippingContentQuery = {
  publicShippingContent?: {
    ...
    shippingInfo: Array<{ title: string; content: string }>;
    returnsPolicy: Array<{ icon: string; title: string; description: string }>;
    returnSteps: Array<{ step: string; title: string; description: string }>;
  } | null;
};

export type PublicCareContentQueryVariables = Exact<{ [key: string]: never }>;

export type PublicCareContentQuery = {
  publicCareContent?: {
    safeFor: Array<string>;
    avoid: Array<string>;
    glazeTypes: Array<{
      name: string;
      icon: string;
...
export type PublicPrivacyContentQueryVariables = Exact<{
  [key: string]: never;
}>;

export type PublicPrivacyContentQuery = {
...
export type PublicTermsContentQuery = {
  publicTermsContent?: {
    lastUpdated: string;
    introduction: string;
    contactEmail: string;
...
export type PublicHeroImagesQuery = {
  publicHeroImages: {
    home: string;
    ourStory: string;
    products: string;
...
export type PublicContactInfoQuery = {
  publicContactInfo: {
    address: string;
    email: string;
    phone: string;
...
export type PublicSocialLinksQuery = {
  publicSocialLinks: {
    instagram: string;
    facebook: string;
    twitter: string;
...
export type AdminUpdateRegistrationStatusMutation = {
  adminUpdateRegistrationStatus: { success: boolean; error?: string | null };
};
...
export type AdminUpdateRegistrationPriceMutation = {
  adminUpdateRegistrationPrice: { success: boolean; error?: string | null };
};
...
export type AdminUpdateRegistrationDetailsMutation = {
  adminUpdateRegistrationDetails: { success: boolean; error?: string | null };
};
...
export type AdminUpdateHeroImagesMutation = {
  adminUpdateHeroImages: { success: boolean; error?: string | null };
};
...
export type AdminUpdateContactInfoMutation = {
  adminUpdateContactInfo: { success: boolean; error?: string | null };
};
...
export type AdminUpdateSocialLinksMutation = {
  adminUpdateSocialLinks: { success: boolean; error?: string | null };
};

export type AdminAllSettingsQueryVariables = Exact<{ [key: string]: never }>;

export type AdminAllSettingsQuery = {
  adminAllSettings: Array<{
    id: number;
    key: string;
    value: any;
    updated_at: Date | string;
...
export type AdminHeroImagesQuery = {
  adminHeroImages: {
    home: string;
    ourStory: string;
    products: string;
...
export type AdminContactInfoQuery = {
  adminContactInfo: {
    address: string;
    email: string;
    phone: string;
...
export type AdminSocialLinksQuery = {
  adminSocialLinks: {
    instagram: string;
    facebook: string;
    twitter: string;
...
export type AdminGetPresignedUploadUrlMutation = {
  adminGetPresignedUploadUrl: {
    success: boolean;
...
export type AdminUpdateUserRoleMutation = {
  adminUpdateUserRole: { success: boolean; error?: string | null };
};
...
export type AdminUsersQuery = {
  adminUsers: {
    ...
    users: Array<{
      ...
      _count: { product_orders: number; event_registrations: number };
    }>;
  };
};
...
export type AdminUserOrdersQuery = {
  adminUserOrders: Array<{
    id: string;
    status: string;
    total: number;
    subtotal: number;
...
export type AdminUserCartQuery = {
  adminUserCart: Array<{
    id: number;
    quantity: number;
    created_at: Date | string;
...
export type AdminUserWishlistQuery = {
  adminUserWishlist: {
    total: number;
    page: number;
    totalPages: number;
...
export type MutationRegistrationEventFieldsFragment = {
  id: string;
  slug: string;
  title: string;
  description: string;
...
export type MutationEventRegistrationFieldsFragment = {
  id: string;
  event_id: string;
  user_id: number;
  seats_reserved: number;
...
export type CancelRegistrationMutation = {
  cancelRegistration: { success: boolean; error?: string | null };
};

export type EventBaseFieldsFragment = {
  id: string;
  slug: string;
  title: string;
  description: string;
...
export type EventDetailFieldsFragment = {
  ...
  reviews: Array<{
    ...
    likes: Array<{ id: number; review_id: number; user_id: number }>;
  }>;
};

export type RegistrationEventFieldsFragment = {
  id: string;
  slug: string;
  title: string;
  description: string;
...
export type EventWithUserContextQuery = {
...
export type RegistrationByIdQuery = {
  registrationById?: {
    id: string;
    event_id: string;
    user_id: number;
...
export type UpcomingRegistrationsQuery = {
...
export type CompletedRegistrationsQuery = {
...
export type NewsletterStatusQuery = {
  newsletterStatus: {
    subscribed: boolean;
    subscribed_at?: Date | string | null;
  };
...
export type ProductsQuery = {
  products: {
    ...
    filter: {
      ...
      order_by?: ProductOrderBy | null;
    };
    meta: {
      categories: Array<string>;
      materials: Array<string>;
      price_range: { min: number; max: number };
      price_histogram: Array<{ min: number; max: number; count: number }>;
    };
  };
};
...
export type CreateEventReviewMutation = {
  createEventReview: {
    success: boolean;
    error?: string | null;
    review?: {
...
export type DeleteReviewMutation = {
  deleteReview: { success: boolean; error?: string | null };
};
...
export type ToggleReviewLikeMutation = {
  toggleReviewLike: {
    success: boolean;
...
// @ts-ignore
export function useUserAddressesSuspenseQuery(
...
export type UserAddressesQueryHookResult = ReturnType<
  typeof useUserAddressesQuery
>;
export type UserAddressesLazyQueryHookResult = ReturnType<
  typeof useUserAddressesLazyQuery
>;
export type UserAddressesSuspenseQueryHookResult = ReturnType<
  typeof useUserAddressesSuspenseQuery
>;
 ...
 * });
 */
export function useAddressByIdQuery(
  baseOptions: ApolloReactHooks.QueryHookOptions<
    AddressByIdQuery,
    AddressByIdQueryVariables
  > &
    (
      | { variables: AddressByIdQueryVariables; skip?: boolean }
      | { skip: boolean }
    ),
) {
  const options = { ...defaultOptions, ...baseOptions };
  return ApolloReactHooks.useQuery<AddressByIdQuery, AddressByIdQueryVariables>(
    AddressByIdDocument,
    options,
  );
}
export function useAddressByIdLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    AddressByIdQuery,
    AddressByIdQueryVariables
  >,
  ...
  return ApolloReactHooks.useLazyQuery<
    AddressByIdQuery,
    AddressByIdQueryVariables
  >(AddressByIdDocument, options);
}
// @ts-ignore
export function useAddressByIdSuspenseQuery(
  baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<
    AddressByIdQuery,
    AddressByIdQueryVariables
  >,
...
export type AddressByIdLazyQueryHookResult = ReturnType<
  typeof useAddressByIdLazyQuery
>;
export type AddressByIdSuspenseQueryHookResult = ReturnType<
  typeof useAddressByIdSuspenseQuery
>;
...
export type AdminDashboardStatsQueryHookResult = ReturnType<
  typeof useAdminDashboardStatsQuery
>;
 ...
 * });
 */
export function useAdminRecentOrdersQuery(
  baseOptions?: ApolloReactHooks.QueryHookOptions<
  ...
  return ApolloReactHooks.useQuery<
    AdminRecentOrdersQuery,
    AdminRecentOrdersQueryVariables
  >(AdminRecentOrdersDocument, options);
}
export function useAdminRecentOrdersLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    AdminRecentOrdersQuery,
    AdminRecentOrdersQueryVariables
  >,
...
// @ts-ignore
export function useAdminRecentOrdersSuspenseQuery(
  baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<
    AdminRecentOrdersQuery,
    AdminRecentOrdersQueryVariables
  >,
...
export function useAdminRecentOrdersSuspenseQuery(
  ...
  AdminRecentOrdersQuery | undefined,
  AdminRecentOrdersQueryVariables
>;
export function useAdminRecentOrdersSuspenseQuery(
  baseOptions?:
...
export type AdminRecentOrdersQueryHookResult = ReturnType<
  typeof useAdminRecentOrdersQuery
>;
export type AdminRecentOrdersLazyQueryHookResult = ReturnType<
  typeof useAdminRecentOrdersLazyQuery
>;
export type AdminRecentOrdersSuspenseQueryHookResult = ReturnType<
  typeof useAdminRecentOrdersSuspenseQuery
>;
 ...
 * });
 */
export function useAdminRecentRegistrationsQuery(
  baseOptions?: ApolloReactHooks.QueryHookOptions<
  ...
  return ApolloReactHooks.useQuery<
    AdminRecentRegistrationsQuery,
    AdminRecentRegistrationsQueryVariables
  >(AdminRecentRegistrationsDocument, options);
}
export function useAdminRecentRegistrationsLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    AdminRecentRegistrationsQuery,
    AdminRecentRegistrationsQueryVariables
  >,
...
// @ts-ignore
export function useAdminRecentRegistrationsSuspenseQuery(
  baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<
    AdminRecentRegistrationsQuery,
    AdminRecentRegistrationsQueryVariables
  >,
...
export function useAdminRecentRegistrationsSuspenseQuery(
  ...
  AdminRecentRegistrationsQuery | undefined,
  AdminRecentRegistrationsQueryVariables
>;
export function useAdminRecentRegistrationsSuspenseQuery(
  baseOptions?:
...
export type AdminRecentRegistrationsQueryHookResult = ReturnType<
  typeof useAdminRecentRegistrationsQuery
>;
export type AdminRecentRegistrationsLazyQueryHookResult = ReturnType<
  typeof useAdminRecentRegistrationsLazyQuery
>;
export type AdminRecentRegistrationsSuspenseQueryHookResult = ReturnType<
  typeof useAdminRecentRegistrationsSuspenseQuery
>;
 ...
 * });
 */
export function useAdminLowStockProductsQuery(
  baseOptions?: ApolloReactHooks.QueryHookOptions<
  ...
  return ApolloReactHooks.useQuery<
    AdminLowStockProductsQuery,
    AdminLowStockProductsQueryVariables
  >(AdminLowStockProductsDocument, options);
}
export function useAdminLowStockProductsLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    AdminLowStockProductsQuery,
    AdminLowStockProductsQueryVariables
  >,
...
// @ts-ignore
export function useAdminLowStockProductsSuspenseQuery(
  baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<
    AdminLowStockProductsQuery,
    AdminLowStockProductsQueryVariables
  >,
...
export function useAdminLowStockProductsSuspenseQuery(
  ...
  AdminLowStockProductsQuery | undefined,
  AdminLowStockProductsQueryVariables
>;
export function useAdminLowStockProductsSuspenseQuery(
  baseOptions?:
...
export type AdminLowStockProductsQueryHookResult = ReturnType<
  typeof useAdminLowStockProductsQuery
>;
export type AdminLowStockProductsLazyQueryHookResult = ReturnType<
  typeof useAdminLowStockProductsLazyQuery
>;
export type AdminLowStockProductsSuspenseQueryHookResult = ReturnType<
  typeof useAdminLowStockProductsSuspenseQuery
>;
 ...
 * });
 */
export function useAdminUpcomingEventsQuery(
  baseOptions?: ApolloReactHooks.QueryHookOptions<
  ...
  return ApolloReactHooks.useQuery<
    AdminUpcomingEventsQuery,
    AdminUpcomingEventsQueryVariables
  >(AdminUpcomingEventsDocument, options);
}
export function useAdminUpcomingEventsLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    AdminUpcomingEventsQuery,
    AdminUpcomingEventsQueryVariables
  >,
...
// @ts-ignore
export function useAdminUpcomingEventsSuspenseQuery(
  baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<
    AdminUpcomingEventsQuery,
    AdminUpcomingEventsQueryVariables
  >,
...
export function useAdminUpcomingEventsSuspenseQuery(
  ...
  AdminUpcomingEventsQuery | undefined,
  AdminUpcomingEventsQueryVariables
>;
export function useAdminUpcomingEventsSuspenseQuery(
  baseOptions?:
...
export type AdminUpcomingEventsQueryHookResult = ReturnType<
  typeof useAdminUpcomingEventsQuery
>;
export type AdminUpcomingEventsLazyQueryHookResult = ReturnType<
  typeof useAdminUpcomingEventsLazyQuery
>;
export type AdminUpcomingEventsSuspenseQueryHookResult = ReturnType<
  typeof useAdminUpcomingEventsSuspenseQuery
>;
...
export function useAdminNewsletterSubscribersQuery(
  ...
  return ApolloReactHooks.useQuery<
    AdminNewsletterSubscribersQuery,
    AdminNewsletterSubscribersQueryVariables
  >(AdminNewsletterSubscribersDocument, options);
}
export function useAdminNewsletterSubscribersLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    AdminNewsletterSubscribersQuery,
    AdminNewsletterSubscribersQueryVariables
  >,
...
export function useAdminNewsletterSubscribersSuspenseQuery(
  ...
  AdminNewsletterSubscribersQuery | undefined,
  AdminNewsletterSubscribersQueryVariables
>;
export function useAdminNewsletterSubscribersSuspenseQuery(
  baseOptions?:
...
export type AdminNewsletterSubscribersQueryHookResult = ReturnType<
  typeof useAdminNewsletterSubscribersQuery
>;
export type AdminNewsletterSubscribersLazyQueryHookResult = ReturnType<
  typeof useAdminNewsletterSubscribersLazyQuery
>;
export type AdminNewsletterSubscribersSuspenseQueryHookResult = ReturnType<
  typeof useAdminNewsletterSubscribersSuspenseQuery
>;
 ...
 * });
 */
export function useAdminUpdateCategoryIconMutation(
  baseOptions?: ApolloReactHooks.MutationHookOptions<
  ...
  return ApolloReactHooks.useMutation<
    AdminUpdateCategoryIconMutation,
    AdminUpdateCategoryIconMutationVariables
  >(AdminUpdateCategoryIconDocument, options);
}
export type AdminUpdateCategoryIconMutationHookResult = ReturnType<
  typeof useAdminUpdateCategoryIconMutation
>;
...
export function useAdminAddCategoryMutation(
  ...
  return ApolloReactHooks.useMutation<
    AdminAddCategoryMutation,
    AdminAddCategoryMutationVariables
  >(AdminAddCategoryDocument, options);
}
export type AdminAddCategoryMutationHookResult = ReturnType<
  typeof useAdminAddCategoryMutation
>;
 ...
 * });
 */
export function useAdminRenameCategoryMutation(
  baseOptions?: ApolloReactHooks.MutationHookOptions<
  ...
  return ApolloReactHooks.useMutation<
    AdminRenameCategoryMutation,
    AdminRenameCategoryMutationVariables
  >(AdminRenameCategoryDocument, options);
}
export type AdminRenameCategoryMutationHookResult = ReturnType<
  typeof useAdminRenameCategoryMutation
>;
...
export function useAdminCategoriesQuery(
  ...
  return ApolloReactHooks.useQuery<
    AdminCategoriesQuery,
    AdminCategoriesQueryVariables
  >(AdminCategoriesDocument, options);
}
export function useAdminCategoriesLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    AdminCategoriesQuery,
    AdminCategoriesQueryVariables
  >,
...
// @ts-ignore
export function useAdminCategoriesSuspenseQuery(
  baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<
    AdminCategoriesQuery,
    AdminCategoriesQueryVariables
  >,
...
export function useAdminCategoriesSuspenseQuery(
  ...
  AdminCategoriesQuery | undefined,
  AdminCategoriesQueryVariables
>;
export function useAdminCategoriesSuspenseQuery(
  baseOptions?:
...
export type AdminCategoriesQueryHookResult = ReturnType<
  typeof useAdminCategoriesQuery
>;
export type AdminCategoriesLazyQueryHookResult = ReturnType<
  typeof useAdminCategoriesLazyQuery
>;
export type AdminCategoriesSuspenseQueryHookResult = ReturnType<
  typeof useAdminCategoriesSuspenseQuery
>;
 ...
 * });
 */
export function useAdminAllConfiguredCategoriesQuery(
  baseOptions?: ApolloReactHooks.QueryHookOptions<
    AdminAllConfiguredCategoriesQuery,
    AdminAllConfiguredCategoriesQueryVariables
  >,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return ApolloReactHooks.useQuery<
    AdminAllConfiguredCategoriesQuery,
    AdminAllConfiguredCategoriesQueryVariables
  >(AdminAllConfiguredCategoriesDocument, options);
}
export function useAdminAllConfiguredCategoriesLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    AdminAllConfiguredCategoriesQuery,
    AdminAllConfiguredCategoriesQueryVariables
  >,
...
export function useAdminAllConfiguredCategoriesSuspenseQuery(
  ...
  AdminAllConfiguredCategoriesQuery | undefined,
  AdminAllConfiguredCategoriesQueryVariables
>;
export function useAdminAllConfiguredCategoriesSuspenseQuery(
  baseOptions?:
...
export type AdminAllConfiguredCategoriesQueryHookResult = ReturnType<
  typeof useAdminAllConfiguredCategoriesQuery
>;
export type AdminAllConfiguredCategoriesLazyQueryHookResult = ReturnType<
  typeof useAdminAllConfiguredCategoriesLazyQuery
>;
export type AdminAllConfiguredCategoriesSuspenseQueryHookResult = ReturnType<
  typeof useAdminAllConfiguredCategoriesSuspenseQuery
>;
 ...
 * });
 */
export function useAdminAvailableIconsQuery(
  baseOptions?: ApolloReactHooks.QueryHookOptions<
    AdminAvailableIconsQuery,
    AdminAvailableIconsQueryVariables
  >,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return ApolloReactHooks.useQuery<
    AdminAvailableIconsQuery,
    AdminAvailableIconsQueryVariables
  >(AdminAvailableIconsDocument, options);
}
export function useAdminAvailableIconsLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    AdminAvailableIconsQuery,
    AdminAvailableIconsQueryVariables
  >,
...
// @ts-ignore
export function useAdminAvailableIconsSuspenseQuery(
  baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<
    AdminAvailableIconsQuery,
    AdminAvailableIconsQueryVariables
  >,
...
export function useAdminAvailableIconsSuspenseQuery(
  ...
  AdminAvailableIconsQuery | undefined,
  AdminAvailableIconsQueryVariables
>;
export function useAdminAvailableIconsSuspenseQuery(
  baseOptions?:
...
export type AdminAvailableIconsQueryHookResult = ReturnType<
  typeof useAdminAvailableIconsQuery
>;
export type AdminAvailableIconsLazyQueryHookResult = ReturnType<
  typeof useAdminAvailableIconsLazyQuery
>;
export type AdminAvailableIconsSuspenseQueryHookResult = ReturnType<
  typeof useAdminAvailableIconsSuspenseQuery
>;
 ...
 * });
 */
export function useAdminUpdateContentPageMutation(
  baseOptions?: ApolloReactHooks.MutationHookOptions<
  ...
  return ApolloReactHooks.useMutation<
    AdminUpdateContentPageMutation,
    AdminUpdateContentPageMutationVariables
  >(AdminUpdateContentPageDocument, options);
}
export type AdminUpdateContentPageMutationHookResult = ReturnType<
  typeof useAdminUpdateContentPageMutation
>;
 ...
 * });
 */
export function useAdminToggleContentPageActiveMutation(
  baseOptions?: ApolloReactHooks.MutationHookOptions<
  ...
  return ApolloReactHooks.useMutation<
    AdminToggleContentPageActiveMutation,
    AdminToggleContentPageActiveMutationVariables
  >(AdminToggleContentPageActiveDocument, options);
}
export type AdminToggleContentPageActiveMutationHookResult = ReturnType<
  typeof useAdminToggleContentPageActiveMutation
>;
...
export function useAdminContentPagesQuery(
  baseOptions?: ApolloReactHooks.QueryHookOptions<
    ...
    AdminContentPagesQueryVariables
  >,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return ApolloReactHooks.useQuery<
    AdminContentPagesQuery,
    AdminContentPagesQueryVariables
  >(AdminContentPagesDocument, options);
}
export function useAdminContentPagesLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    AdminContentPagesQuery,
    AdminContentPagesQueryVariables
  >,
...
// @ts-ignore
export function useAdminContentPagesSuspenseQuery(
  baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<
    AdminContentPagesQuery,
    AdminContentPagesQueryVariables
  >,
...
export function useAdminContentPagesSuspenseQuery(
  ...
  AdminContentPagesQuery | undefined,
  AdminContentPagesQueryVariables
>;
export function useAdminContentPagesSuspenseQuery(
  baseOptions?:
...
export type AdminContentPagesQueryHookResult = ReturnType<
  typeof useAdminContentPagesQuery
>;
export type AdminContentPagesLazyQueryHookResult = ReturnType<
  typeof useAdminContentPagesLazyQuery
>;
export type AdminContentPagesSuspenseQueryHookResult = ReturnType<
  typeof useAdminContentPagesSuspenseQuery
>;
 ...
 * });
 */
export function useAdminContentPageBySlugQuery(
  baseOptions: ApolloReactHooks.QueryHookOptions<
    AdminContentPageBySlugQuery,
    AdminContentPageBySlugQueryVariables
  > &
    (
      | { variables: AdminContentPageBySlugQueryVariables; skip?: boolean }
      | { skip: boolean }
    ),
) {
  const options = { ...defaultOptions, ...baseOptions };
  return ApolloReactHooks.useQuery<
    AdminContentPageBySlugQuery,
    AdminContentPageBySlugQueryVariables
  >(AdminContentPageBySlugDocument, options);
}
export function useAdminContentPageBySlugLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    AdminContentPageBySlugQuery,
    AdminContentPageBySlugQueryVariables
  >,
...
// @ts-ignore
export function useAdminContentPageBySlugSuspenseQuery(
  baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<
    AdminContentPageBySlugQuery,
    AdminContentPageBySlugQueryVariables
  >,
...
export function useAdminContentPageBySlugSuspenseQuery(
  ...
  AdminContentPageBySlugQuery | undefined,
  AdminContentPageBySlugQueryVariables
>;
export function useAdminContentPageBySlugSuspenseQuery(
  baseOptions?:
...
export type AdminContentPageBySlugQueryHookResult = ReturnType<
  typeof useAdminContentPageBySlugQuery
>;
export type AdminContentPageBySlugLazyQueryHookResult = ReturnType<
  typeof useAdminContentPageBySlugLazyQuery
>;
export type AdminContentPageBySlugSuspenseQueryHookResult = ReturnType<
  typeof useAdminContentPageBySlugSuspenseQuery
>;
 ...
 * });
 */
export function useAdminUpdateEventStatusMutation(
  baseOptions?: ApolloReactHooks.MutationHookOptions<
  ...
  return ApolloReactHooks.useMutation<
    AdminUpdateEventStatusMutation,
    AdminUpdateEventStatusMutationVariables
  >(AdminUpdateEventStatusDocument, options);
}
export type AdminUpdateEventStatusMutationHookResult = ReturnType<
  typeof useAdminUpdateEventStatusMutation
>;
 ...
 * });
 */
export function useAdminDeleteEventReviewMutation(
  baseOptions?: ApolloReactHooks.MutationHookOptions<
  ...
  return ApolloReactHooks.useMutation<
    AdminDeleteEventReviewMutation,
    AdminDeleteEventReviewMutationVariables
  >(AdminDeleteEventReviewDocument, options);
}
export type AdminDeleteEventReviewMutationHookResult = ReturnType<
  typeof useAdminDeleteEventReviewMutation
>;
...
export function useAdminEventsQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return ApolloReactHooks.useQuery<AdminEventsQuery, AdminEventsQueryVariables>(
    AdminEventsDocument,
    options,
  );
}
export function useAdminEventsLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    AdminEventsQuery,
    AdminEventsQueryVariables
  >,
  ...
  return ApolloReactHooks.useLazyQuery<
    AdminEventsQuery,
    AdminEventsQueryVariables
  >(AdminEventsDocument, options);
}
// @ts-ignore
export function useAdminEventsSuspenseQuery(
  baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<
    AdminEventsQuery,
    AdminEventsQueryVariables
  >,
...
export type AdminEventsLazyQueryHookResult = ReturnType<
  typeof useAdminEventsLazyQuery
>;
export type AdminEventsSuspenseQueryHookResult = ReturnType<
  typeof useAdminEventsSuspenseQuery
>;
 ...
 * });
 */
export function useAdminEventByIdQuery(
  baseOptions: ApolloReactHooks.QueryHookOptions<
    AdminEventByIdQuery,
    AdminEventByIdQueryVariables
  > &
    (
      | { variables: AdminEventByIdQueryVariables; skip?: boolean }
      | { skip: boolean }
    ),
) {
  const options = { ...defaultOptions, ...baseOptions };
  return ApolloReactHooks.useQuery<
    AdminEventByIdQuery,
    AdminEventByIdQueryVariables
  >(AdminEventByIdDocument, options);
}
export function useAdminEventByIdLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    AdminEventByIdQuery,
    AdminEventByIdQueryVariables
  >,
...
// @ts-ignore
export function useAdminEventByIdSuspenseQuery(
  baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<
    AdminEventByIdQuery,
    AdminEventByIdQueryVariables
  >,
...
export type AdminEventByIdQueryHookResult = ReturnType<
  typeof useAdminEventByIdQuery
>;
export type AdminEventByIdLazyQueryHookResult = ReturnType<
  typeof useAdminEventByIdLazyQuery
>;
export type AdminEventByIdSuspenseQueryHookResult = ReturnType<
  typeof useAdminEventByIdSuspenseQuery
>;
...
export function useAdminEventRegistrationsQuery(
  ...
  > &
    (
      | { variables: AdminEventRegistrationsQueryVariables; skip?: boolean }
      | { skip: boolean }
    ),
) {
  const options = { ...defaultOptions, ...baseOptions };
  return ApolloReactHooks.useQuery<
    AdminEventRegistrationsQuery,
    AdminEventRegistrationsQueryVariables
  >(AdminEventRegistrationsDocument, options);
}
export function useAdminEventRegistrationsLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    AdminEventRegistrationsQuery,
    AdminEventRegistrationsQueryVariables
  >,
...
// @ts-ignore
export function useAdminEventRegistrationsSuspenseQuery(
  baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<
    AdminEventRegistrationsQuery,
    AdminEventRegistrationsQueryVariables
  >,
...
export function useAdminEventRegistrationsSuspenseQuery(
  ...
  AdminEventRegistrationsQuery | undefined,
  AdminEventRegistrationsQueryVariables
>;
export function useAdminEventRegistrationsSuspenseQuery(
  baseOptions?:
...
export type AdminEventRegistrationsQueryHookResult = ReturnType<
  typeof useAdminEventRegistrationsQuery
>;
export type AdminEventRegistrationsLazyQueryHookResult = ReturnType<
  typeof useAdminEventRegistrationsLazyQuery
>;
export type AdminEventRegistrationsSuspenseQueryHookResult = ReturnType<
  typeof useAdminEventRegistrationsSuspenseQuery
>;
 ...
 * });
 */
export function useAdminEventReviewsQuery(
  baseOptions: ApolloReactHooks.QueryHookOptions<
    AdminEventReviewsQuery,
    AdminEventReviewsQueryVariables
  > &
    (
      | { variables: AdminEventReviewsQueryVariables; skip?: boolean }
      | { skip: boolean }
    ),
) {
  const options = { ...defaultOptions, ...baseOptions };
  return ApolloReactHooks.useQuery<
    AdminEventReviewsQuery,
    AdminEventReviewsQueryVariables
  >(AdminEventReviewsDocument, options);
}
export function useAdminEventReviewsLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    AdminEventReviewsQuery,
    AdminEventReviewsQueryVariables
  >,
...
// @ts-ignore
export function useAdminEventReviewsSuspenseQuery(
  baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<
    AdminEventReviewsQuery,
    AdminEventReviewsQueryVariables
  >,
...
export function useAdminEventReviewsSuspenseQuery(
  ...
  AdminEventReviewsQuery | undefined,
  AdminEventReviewsQueryVariables
>;
export function useAdminEventReviewsSuspenseQuery(
  baseOptions?:
...
export type AdminEventReviewsQueryHookResult = ReturnType<
  typeof useAdminEventReviewsQuery
>;
export type AdminEventReviewsLazyQueryHookResult = ReturnType<
  typeof useAdminEventReviewsLazyQuery
>;
export type AdminEventReviewsSuspenseQueryHookResult = ReturnType<
  typeof useAdminEventReviewsSuspenseQuery
>;
 ...
 * });
 */
export function useAdminEventStatusOptionsQuery(
  baseOptions?: ApolloReactHooks.QueryHookOptions<
    AdminEventStatusOptionsQuery,
    AdminEventStatusOptionsQueryVariables
  >,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return ApolloReactHooks.useQuery<
    AdminEventStatusOptionsQuery,
    AdminEventStatusOptionsQueryVariables
  >(AdminEventStatusOptionsDocument, options);
}
export function useAdminEventStatusOptionsLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    AdminEventStatusOptionsQuery,
    AdminEventStatusOptionsQueryVariables
  >,
...
// @ts-ignore
export function useAdminEventStatusOptionsSuspenseQuery(
  baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<
    AdminEventStatusOptionsQuery,
    AdminEventStatusOptionsQueryVariables
  >,
...
export function useAdminEventStatusOptionsSuspenseQuery(
  ...
  AdminEventStatusOptionsQuery | undefined,
  AdminEventStatusOptionsQueryVariables
>;
export function useAdminEventStatusOptionsSuspenseQuery(
  baseOptions?:
...
export type AdminEventStatusOptionsQueryHookResult = ReturnType<
  typeof useAdminEventStatusOptionsQuery
>;
export type AdminEventStatusOptionsLazyQueryHookResult = ReturnType<
  typeof useAdminEventStatusOptionsLazyQuery
>;
export type AdminEventStatusOptionsSuspenseQueryHookResult = ReturnType<
  typeof useAdminEventStatusOptionsSuspenseQuery
>;
 ...
 * });
 */
export function useAdminEventLevelOptionsQuery(
  baseOptions?: ApolloReactHooks.QueryHookOptions<
  ...
  return ApolloReactHooks.useQuery<
    AdminEventLevelOptionsQuery,
    AdminEventLevelOptionsQueryVariables
  >(AdminEventLevelOptionsDocument, options);
}
export function useAdminEventLevelOptionsLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    AdminEventLevelOptionsQuery,
    AdminEventLevelOptionsQueryVariables
  >,
...
export function useAdminEventLevelOptionsSuspenseQuery(
  ...
  AdminEventLevelOptionsQuery | undefined,
  AdminEventLevelOptionsQueryVariables
>;
export function useAdminEventLevelOptionsSuspenseQuery(
  baseOptions?:
...
export type AdminEventLevelOptionsQueryHookResult = ReturnType<
  typeof useAdminEventLevelOptionsQuery
>;
export type AdminEventLevelOptionsLazyQueryHookResult = ReturnType<
  typeof useAdminEventLevelOptionsLazyQuery
>;
export type AdminEventLevelOptionsSuspenseQueryHookResult = ReturnType<
  typeof useAdminEventLevelOptionsSuspenseQuery
>;
...
export function useAdminUpdateOrderStatusMutation(
  ...
  return ApolloReactHooks.useMutation<
    AdminUpdateOrderStatusMutation,
    AdminUpdateOrderStatusMutationVariables
  >(AdminUpdateOrderStatusDocument, options);
}
export type AdminUpdateOrderStatusMutationHookResult = ReturnType<
  typeof useAdminUpdateOrderStatusMutation
>;
 ...
 * });
 */
export function useAdminUpdateOrderPriceMutation(
  baseOptions?: ApolloReactHooks.MutationHookOptions<
  ...
  return ApolloReactHooks.useMutation<
    AdminUpdateOrderPriceMutation,
    AdminUpdateOrderPriceMutationVariables
  >(AdminUpdateOrderPriceDocument, options);
}
export type AdminUpdateOrderPriceMutationHookResult = ReturnType<
  typeof useAdminUpdateOrderPriceMutation
>;
 ...
 * });
 */
export function useAdminUpdateOrderDiscountMutation(
  baseOptions?: ApolloReactHooks.MutationHookOptions<
  ...
  return ApolloReactHooks.useMutation<
    AdminUpdateOrderDiscountMutation,
    AdminUpdateOrderDiscountMutationVariables
  >(AdminUpdateOrderDiscountDocument, options);
}
export type AdminUpdateOrderDiscountMutationHookResult = ReturnType<
  typeof useAdminUpdateOrderDiscountMutation
>;
 ...
 * });
 */
export function useAdminUpdateOrderItemDiscountMutation(
  baseOptions?: ApolloReactHooks.MutationHookOptions<
  ...
  return ApolloReactHooks.useMutation<
    AdminUpdateOrderItemDiscountMutation,
    AdminUpdateOrderItemDiscountMutationVariables
  >(AdminUpdateOrderItemDiscountDocument, options);
}
export type AdminUpdateOrderItemDiscountMutationHookResult = ReturnType<
  typeof useAdminUpdateOrderItemDiscountMutation
>;
 ...
 * });
 */
export function useAdminUpdateOrderItemQuantityMutation(
  baseOptions?: ApolloReactHooks.MutationHookOptions<
  ...
  return ApolloReactHooks.useMutation<
    AdminUpdateOrderItemQuantityMutation,
    AdminUpdateOrderItemQuantityMutationVariables
  >(AdminUpdateOrderItemQuantityDocument, options);
}
export type AdminUpdateOrderItemQuantityMutationHookResult = ReturnType<
  typeof useAdminUpdateOrderItemQuantityMutation
>;
...
export function useAdminCreateProductMutation(
  ...
  return ApolloReactHooks.useMutation<
    AdminCreateProductMutation,
    AdminCreateProductMutationVariables
  >(AdminCreateProductDocument, options);
}
export type AdminCreateProductMutationHookResult = ReturnType<
  typeof useAdminCreateProductMutation
>;
...
export function useAdminUpdateProductMutation(
  ...
  return ApolloReactHooks.useMutation<
    AdminUpdateProductMutation,
    AdminUpdateProductMutationVariables
  >(AdminUpdateProductDocument, options);
}
export type AdminUpdateProductMutationHookResult = ReturnType<
  typeof useAdminUpdateProductMutation
>;
...
export function useAdminDeleteProductMutation(
  ...
  return ApolloReactHooks.useMutation<
    AdminDeleteProductMutation,
    AdminDeleteProductMutationVariables
  >(AdminDeleteProductDocument, options);
}
export type AdminDeleteProductMutationHookResult = ReturnType<
  typeof useAdminDeleteProductMutation
>;
 ...
 * });
 */
export function useAdminToggleProductActiveMutation(
  baseOptions?: ApolloReactHooks.MutationHookOptions<
  ...
  return ApolloReactHooks.useMutation<
    AdminToggleProductActiveMutation,
    AdminToggleProductActiveMutationVariables
  >(AdminToggleProductActiveDocument, options);
}
export type AdminToggleProductActiveMutationHookResult = ReturnType<
  typeof useAdminToggleProductActiveMutation
>;
 ...
 * });
 */
export function useAdminDeleteProductReviewMutation(
  baseOptions?: ApolloReactHooks.MutationHookOptions<
  ...
  return ApolloReactHooks.useMutation<
    AdminDeleteProductReviewMutation,
    AdminDeleteProductReviewMutationVariables
  >(AdminDeleteProductReviewDocument, options);
}
export type AdminDeleteProductReviewMutationHookResult = ReturnType<
  typeof useAdminDeleteProductReviewMutation
>;
...
// @ts-ignore
export function useAdminProductsSuspenseQuery(
  baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<
    AdminProductsQuery,
    AdminProductsQueryVariables
  >,
...
>;
export type AdminProductsSuspenseQueryHookResult = ReturnType<
  typeof useAdminProductsSuspenseQuery
>;
 ...
 * });
 */
export function useAdminProductByIdQuery(
  baseOptions: ApolloReactHooks.QueryHookOptions<
    AdminProductByIdQuery,
    AdminProductByIdQueryVariables
  > &
    (
      | { variables: AdminProductByIdQueryVariables; skip?: boolean }
      | { skip: boolean }
    ),
) {
  const options = { ...defaultOptions, ...baseOptions };
  return ApolloReactHooks.useQuery<
    AdminProductByIdQuery,
    AdminProductByIdQueryVariables
  >(AdminProductByIdDocument, options);
}
export function useAdminProductByIdLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    AdminProductByIdQuery,
    AdminProductByIdQueryVariables
  >,
...
// @ts-ignore
export function useAdminProductByIdSuspenseQuery(
  baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<
    AdminProductByIdQuery,
    AdminProductByIdQueryVariables
  >,
...
export function useAdminProductByIdSuspenseQuery(
  ...
  AdminProductByIdQuery | undefined,
  AdminProductByIdQueryVariables
>;
export function useAdminProductByIdSuspenseQuery(
  baseOptions?:
...
export type AdminProductByIdQueryHookResult = ReturnType<
  typeof useAdminProductByIdQuery
>;
export type AdminProductByIdLazyQueryHookResult = ReturnType<
  typeof useAdminProductByIdLazyQuery
>;
export type AdminProductByIdSuspenseQueryHookResult = ReturnType<
  typeof useAdminProductByIdSuspenseQuery
>;
 ...
 * });
 */
export function useAdminProductReviewsQuery(
  baseOptions: ApolloReactHooks.QueryHookOptions<
    AdminProductReviewsQuery,
    AdminProductReviewsQueryVariables
  > &
    (
      | { variables: AdminProductReviewsQueryVariables; skip?: boolean }
      | { skip: boolean }
    ),
) {
  const options = { ...defaultOptions, ...baseOptions };
  return ApolloReactHooks.useQuery<
    AdminProductReviewsQuery,
    AdminProductReviewsQueryVariables
  >(AdminProductReviewsDocument, options);
}
export function useAdminProductReviewsLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    AdminProductReviewsQuery,
    AdminProductReviewsQueryVariables
  >,
...
// @ts-ignore
export function useAdminProductReviewsSuspenseQuery(
  baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<
    AdminProductReviewsQuery,
    AdminProductReviewsQueryVariables
  >,
...
export function useAdminProductReviewsSuspenseQuery(
  ...
  AdminProductReviewsQuery | undefined,
  AdminProductReviewsQueryVariables
>;
export function useAdminProductReviewsSuspenseQuery(
  baseOptions?:
...
export type AdminProductReviewsQueryHookResult = ReturnType<
  typeof useAdminProductReviewsQuery
>;
export type AdminProductReviewsLazyQueryHookResult = ReturnType<
  typeof useAdminProductReviewsLazyQuery
>;
export type AdminProductReviewsSuspenseQueryHookResult = ReturnType<
  typeof useAdminProductReviewsSuspenseQuery
>;
...
export function useAdminAllCategoriesQuery(
  baseOptions?: ApolloReactHooks.QueryHookOptions<
    ...
    AdminAllCategoriesQueryVariables
  >,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return ApolloReactHooks.useQuery<
    AdminAllCategoriesQuery,
    AdminAllCategoriesQueryVariables
  >(AdminAllCategoriesDocument, options);
}
export function useAdminAllCategoriesLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    AdminAllCategoriesQuery,
    AdminAllCategoriesQueryVariables
  >,
...
// @ts-ignore
export function useAdminAllCategoriesSuspenseQuery(
  baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<
    AdminAllCategoriesQuery,
    AdminAllCategoriesQueryVariables
  >,
...
export function useAdminAllCategoriesSuspenseQuery(
  ...
  AdminAllCategoriesQuery | undefined,
  AdminAllCategoriesQueryVariables
>;
export function useAdminAllCategoriesSuspenseQuery(
  baseOptions?:
...
export type AdminAllCategoriesQueryHookResult = ReturnType<
  typeof useAdminAllCategoriesQuery
>;
export type AdminAllCategoriesLazyQueryHookResult = ReturnType<
  typeof useAdminAllCategoriesLazyQuery
>;
export type AdminAllCategoriesSuspenseQueryHookResult = ReturnType<
  typeof useAdminAllCategoriesSuspenseQuery
>;
 ...
 * });
 */
export function usePublicAboutContentQuery(
  baseOptions?: ApolloReactHooks.QueryHookOptions<
    PublicAboutContentQuery,
    PublicAboutContentQueryVariables
  >,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return ApolloReactHooks.useQuery<
    PublicAboutContentQuery,
    PublicAboutContentQueryVariables
  >(PublicAboutContentDocument, options);
}
export function usePublicAboutContentLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    PublicAboutContentQuery,
    PublicAboutContentQueryVariables
  >,
...
// @ts-ignore
export function usePublicAboutContentSuspenseQuery(
  baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<
    PublicAboutContentQuery,
    PublicAboutContentQueryVariables
  >,
...
export function usePublicAboutContentSuspenseQuery(
  ...
  PublicAboutContentQuery | undefined,
  PublicAboutContentQueryVariables
>;
export function usePublicAboutContentSuspenseQuery(
  baseOptions?:
...
export type PublicAboutContentQueryHookResult = ReturnType<
  typeof usePublicAboutContentQuery
>;
export type PublicAboutContentLazyQueryHookResult = ReturnType<
  typeof usePublicAboutContentLazyQuery
>;
export type PublicAboutContentSuspenseQueryHookResult = ReturnType<
  typeof usePublicAboutContentSuspenseQuery
>;
 ...
 * });
 */
export function usePublicFaqContentQuery(
  baseOptions?: ApolloReactHooks.QueryHookOptions<
    PublicFaqContentQuery,
    PublicFaqContentQueryVariables
  >,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return ApolloReactHooks.useQuery<
    PublicFaqContentQuery,
    PublicFaqContentQueryVariables
  >(PublicFaqContentDocument, options);
}
export function usePublicFaqContentLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    PublicFaqContentQuery,
    PublicFaqContentQueryVariables
  >,
...
// @ts-ignore
export function usePublicFaqContentSuspenseQuery(
  baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<
    PublicFaqContentQuery,
    PublicFaqContentQueryVariables
  >,
...
export function usePublicFaqContentSuspenseQuery(
  ...
  PublicFaqContentQuery | undefined,
  PublicFaqContentQueryVariables
>;
export function usePublicFaqContentSuspenseQuery(
  baseOptions?:
...
export type PublicFaqContentQueryHookResult = ReturnType<
  typeof usePublicFaqContentQuery
>;
export type PublicFaqContentLazyQueryHookResult = ReturnType<
  typeof usePublicFaqContentLazyQuery
>;
export type PublicFaqContentSuspenseQueryHookResult = ReturnType<
  typeof usePublicFaqContentSuspenseQuery
>;
 ...
 * });
 */
export function usePublicShippingContentQuery(
  baseOptions?: ApolloReactHooks.QueryHookOptions<
    PublicShippingContentQuery,
    PublicShippingContentQueryVariables
  >,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return ApolloReactHooks.useQuery<
    PublicShippingContentQuery,
    PublicShippingContentQueryVariables
  >(PublicShippingContentDocument, options);
}
export function usePublicShippingContentLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    PublicShippingContentQuery,
    PublicShippingContentQueryVariables
  >,
...
// @ts-ignore
export function usePublicShippingContentSuspenseQuery(
  baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<
    PublicShippingContentQuery,
    PublicShippingContentQueryVariables
  >,
...
export function usePublicShippingContentSuspenseQuery(
  ...
  PublicShippingContentQuery | undefined,
  PublicShippingContentQueryVariables
>;
export function usePublicShippingContentSuspenseQuery(
  baseOptions?:
...
export type PublicShippingContentQueryHookResult = ReturnType<
  typeof usePublicShippingContentQuery
>;
export type PublicShippingContentLazyQueryHookResult = ReturnType<
  typeof usePublicShippingContentLazyQuery
>;
export type PublicShippingContentSuspenseQueryHookResult = ReturnType<
  typeof usePublicShippingContentSuspenseQuery
>;
 ...
 * });
 */
export function usePublicCareContentQuery(
  baseOptions?: ApolloReactHooks.QueryHookOptions<
    PublicCareContentQuery,
    PublicCareContentQueryVariables
  >,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return ApolloReactHooks.useQuery<
    PublicCareContentQuery,
    PublicCareContentQueryVariables
  >(PublicCareContentDocument, options);
}
export function usePublicCareContentLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    PublicCareContentQuery,
    PublicCareContentQueryVariables
  >,
...
// @ts-ignore
export function usePublicCareContentSuspenseQuery(
  baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<
    PublicCareContentQuery,
    PublicCareContentQueryVariables
  >,
...
export function usePublicCareContentSuspenseQuery(
  ...
  PublicCareContentQuery | undefined,
  PublicCareContentQueryVariables
>;
export function usePublicCareContentSuspenseQuery(
  baseOptions?:
...
export type PublicCareContentQueryHookResult = ReturnType<
  typeof usePublicCareContentQuery
>;
export type PublicCareContentLazyQueryHookResult = ReturnType<
  typeof usePublicCareContentLazyQuery
>;
export type PublicCareContentSuspenseQueryHookResult = ReturnType<
  typeof usePublicCareContentSuspenseQuery
>;
 ...
 * });
 */
export function usePublicPrivacyContentQuery(
  baseOptions?: ApolloReactHooks.QueryHookOptions<
    PublicPrivacyContentQuery,
    PublicPrivacyContentQueryVariables
  >,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return ApolloReactHooks.useQuery<
    PublicPrivacyContentQuery,
    PublicPrivacyContentQueryVariables
  >(PublicPrivacyContentDocument, options);
}
export function usePublicPrivacyContentLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    PublicPrivacyContentQuery,
    PublicPrivacyContentQueryVariables
  >,
...
export function usePublicPrivacyContentSuspenseQuery(
  ...
  PublicPrivacyContentQuery | undefined,
  PublicPrivacyContentQueryVariables
>;
export function usePublicPrivacyContentSuspenseQuery(
  baseOptions?:
...
export type PublicPrivacyContentQueryHookResult = ReturnType<
  typeof usePublicPrivacyContentQuery
>;
export type PublicPrivacyContentLazyQueryHookResult = ReturnType<
  typeof usePublicPrivacyContentLazyQuery
>;
export type PublicPrivacyContentSuspenseQueryHookResult = ReturnType<
  typeof usePublicPrivacyContentSuspenseQuery
>;
 ...
 * });
 */
export function usePublicTermsContentQuery(
  baseOptions?: ApolloReactHooks.QueryHookOptions<
    PublicTermsContentQuery,
    PublicTermsContentQueryVariables
  >,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return ApolloReactHooks.useQuery<
    PublicTermsContentQuery,
    PublicTermsContentQueryVariables
  >(PublicTermsContentDocument, options);
}
export function usePublicTermsContentLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    PublicTermsContentQuery,
    PublicTermsContentQueryVariables
  >,
...
// @ts-ignore
export function usePublicTermsContentSuspenseQuery(
  baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<
    PublicTermsContentQuery,
    PublicTermsContentQueryVariables
  >,
...
export function usePublicTermsContentSuspenseQuery(
  ...
  PublicTermsContentQuery | undefined,
  PublicTermsContentQueryVariables
>;
export function usePublicTermsContentSuspenseQuery(
  baseOptions?:
...
export type PublicTermsContentQueryHookResult = ReturnType<
  typeof usePublicTermsContentQuery
>;
export type PublicTermsContentLazyQueryHookResult = ReturnType<
  typeof usePublicTermsContentLazyQuery
>;
export type PublicTermsContentSuspenseQueryHookResult = ReturnType<
  typeof usePublicTermsContentSuspenseQuery
>;
...
export function usePublicHeroImagesQuery(
  baseOptions?: ApolloReactHooks.QueryHookOptions<
    ...
    PublicHeroImagesQueryVariables
  >,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return ApolloReactHooks.useQuery<
    PublicHeroImagesQuery,
    PublicHeroImagesQueryVariables
  >(PublicHeroImagesDocument, options);
}
export function usePublicHeroImagesLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    PublicHeroImagesQuery,
    PublicHeroImagesQueryVariables
  >,
...
// @ts-ignore
export function usePublicHeroImagesSuspenseQuery(
  baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<
    PublicHeroImagesQuery,
    PublicHeroImagesQueryVariables
  >,
...
export function usePublicHeroImagesSuspenseQuery(
  ...
  PublicHeroImagesQuery | undefined,
  PublicHeroImagesQueryVariables
>;
export function usePublicHeroImagesSuspenseQuery(
  baseOptions?:
...
export type PublicHeroImagesQueryHookResult = ReturnType<
  typeof usePublicHeroImagesQuery
>;
export type PublicHeroImagesLazyQueryHookResult = ReturnType<
  typeof usePublicHeroImagesLazyQuery
>;
export type PublicHeroImagesSuspenseQueryHookResult = ReturnType<
  typeof usePublicHeroImagesSuspenseQuery
>;
 ...
 * });
 */
export function usePublicContactInfoQuery(
  baseOptions?: ApolloReactHooks.QueryHookOptions<
    PublicContactInfoQuery,
    PublicContactInfoQueryVariables
  >,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return ApolloReactHooks.useQuery<
    PublicContactInfoQuery,
    PublicContactInfoQueryVariables
  >(PublicContactInfoDocument, options);
}
export function usePublicContactInfoLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    PublicContactInfoQuery,
    PublicContactInfoQueryVariables
  >,
...
// @ts-ignore
export function usePublicContactInfoSuspenseQuery(
  baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<
    PublicContactInfoQuery,
    PublicContactInfoQueryVariables
  >,
...
export function usePublicContactInfoSuspenseQuery(
  ...
  PublicContactInfoQuery | undefined,
  PublicContactInfoQueryVariables
>;
export function usePublicContactInfoSuspenseQuery(
  baseOptions?:
...
export type PublicContactInfoQueryHookResult = ReturnType<
  typeof usePublicContactInfoQuery
>;
export type PublicContactInfoLazyQueryHookResult = ReturnType<
  typeof usePublicContactInfoLazyQuery
>;
export type PublicContactInfoSuspenseQueryHookResult = ReturnType<
  typeof usePublicContactInfoSuspenseQuery
>;
...
export function usePublicSocialLinksQuery(
  baseOptions?: ApolloReactHooks.QueryHookOptions<
    ...
    PublicSocialLinksQueryVariables
  >,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return ApolloReactHooks.useQuery<
    PublicSocialLinksQuery,
    PublicSocialLinksQueryVariables
  >(PublicSocialLinksDocument, options);
}
export function usePublicSocialLinksLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    PublicSocialLinksQuery,
    PublicSocialLinksQueryVariables
  >,
...
// @ts-ignore
export function usePublicSocialLinksSuspenseQuery(
  baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<
    PublicSocialLinksQuery,
    PublicSocialLinksQueryVariables
  >,
...
export function usePublicSocialLinksSuspenseQuery(
  ...
  PublicSocialLinksQuery | undefined,
  PublicSocialLinksQueryVariables
>;
export function usePublicSocialLinksSuspenseQuery(
  baseOptions?:
...
export type PublicSocialLinksQueryHookResult = ReturnType<
  typeof usePublicSocialLinksQuery
>;
export type PublicSocialLinksLazyQueryHookResult = ReturnType<
  typeof usePublicSocialLinksLazyQuery
>;
export type PublicSocialLinksSuspenseQueryHookResult = ReturnType<
  typeof usePublicSocialLinksSuspenseQuery
>;
 ...
 * });
 */
export function useAdminUpdateRegistrationStatusMutation(
  baseOptions?: ApolloReactHooks.MutationHookOptions<
  ...
  return ApolloReactHooks.useMutation<
    AdminUpdateRegistrationStatusMutation,
    AdminUpdateRegistrationStatusMutationVariables
  >(AdminUpdateRegistrationStatusDocument, options);
}
export type AdminUpdateRegistrationStatusMutationHookResult = ReturnType<
  typeof useAdminUpdateRegistrationStatusMutation
>;
 ...
 * });
 */
export function useAdminUpdateRegistrationPriceMutation(
  baseOptions?: ApolloReactHooks.MutationHookOptions<
  ...
  return ApolloReactHooks.useMutation<
    AdminUpdateRegistrationPriceMutation,
    AdminUpdateRegistrationPriceMutationVariables
  >(AdminUpdateRegistrationPriceDocument, options);
}
export type AdminUpdateRegistrationPriceMutationHookResult = ReturnType<
  typeof useAdminUpdateRegistrationPriceMutation
>;
 ...
 * });
 */
export function useAdminUpdateRegistrationDetailsMutation(
  baseOptions?: ApolloReactHooks.MutationHookOptions<
  ...
  return ApolloReactHooks.useMutation<
    AdminUpdateRegistrationDetailsMutation,
    AdminUpdateRegistrationDetailsMutationVariables
  >(AdminUpdateRegistrationDetailsDocument, options);
}
export type AdminUpdateRegistrationDetailsMutationHookResult = ReturnType<
  typeof useAdminUpdateRegistrationDetailsMutation
>;
 ...
 * });
 */
export function useAdminUpdateHeroImagesMutation(
  baseOptions?: ApolloReactHooks.MutationHookOptions<
  ...
  return ApolloReactHooks.useMutation<
    AdminUpdateHeroImagesMutation,
    AdminUpdateHeroImagesMutationVariables
  >(AdminUpdateHeroImagesDocument, options);
}
export type AdminUpdateHeroImagesMutationHookResult = ReturnType<
  typeof useAdminUpdateHeroImagesMutation
>;
 ...
 * });
 */
export function useAdminUpdateContactInfoMutation(
  baseOptions?: ApolloReactHooks.MutationHookOptions<
  ...
  return ApolloReactHooks.useMutation<
    AdminUpdateContactInfoMutation,
    AdminUpdateContactInfoMutationVariables
  >(AdminUpdateContactInfoDocument, options);
}
export type AdminUpdateContactInfoMutationHookResult = ReturnType<
  typeof useAdminUpdateContactInfoMutation
>;
 ...
 * });
 */
export function useAdminUpdateSocialLinksMutation(
  baseOptions?: ApolloReactHooks.MutationHookOptions<
  ...
  return ApolloReactHooks.useMutation<
    AdminUpdateSocialLinksMutation,
    AdminUpdateSocialLinksMutationVariables
  >(AdminUpdateSocialLinksDocument, options);
}
export type AdminUpdateSocialLinksMutationHookResult = ReturnType<
  typeof useAdminUpdateSocialLinksMutation
>;
 ...
 * });
 */
export function useAdminAllSettingsQuery(
  baseOptions?: ApolloReactHooks.QueryHookOptions<
    AdminAllSettingsQuery,
    AdminAllSettingsQueryVariables
  >,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return ApolloReactHooks.useQuery<
    AdminAllSettingsQuery,
    AdminAllSettingsQueryVariables
  >(AdminAllSettingsDocument, options);
}
export function useAdminAllSettingsLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    AdminAllSettingsQuery,
    AdminAllSettingsQueryVariables
  >,
...
// @ts-ignore
export function useAdminAllSettingsSuspenseQuery(
  baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<
    AdminAllSettingsQuery,
    AdminAllSettingsQueryVariables
  >,
...
export function useAdminAllSettingsSuspenseQuery(
  ...
  AdminAllSettingsQuery | undefined,
  AdminAllSettingsQueryVariables
>;
export function useAdminAllSettingsSuspenseQuery(
  baseOptions?:
...
export type AdminAllSettingsQueryHookResult = ReturnType<
  typeof useAdminAllSettingsQuery
>;
export type AdminAllSettingsLazyQueryHookResult = ReturnType<
  typeof useAdminAllSettingsLazyQuery
>;
export type AdminAllSettingsSuspenseQueryHookResult = ReturnType<
  typeof useAdminAllSettingsSuspenseQuery
>;
 ...
 * });
 */
export function useAdminHeroImagesQuery(
  baseOptions?: ApolloReactHooks.QueryHookOptions<
    AdminHeroImagesQuery,
    AdminHeroImagesQueryVariables
  >,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return ApolloReactHooks.useQuery<
    AdminHeroImagesQuery,
    AdminHeroImagesQueryVariables
  >(AdminHeroImagesDocument, options);
}
export function useAdminHeroImagesLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    AdminHeroImagesQuery,
    AdminHeroImagesQueryVariables
  >,
...
// @ts-ignore
export function useAdminHeroImagesSuspenseQuery(
  baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<
    AdminHeroImagesQuery,
    AdminHeroImagesQueryVariables
  >,
...
export function useAdminHeroImagesSuspenseQuery(
  ...
  AdminHeroImagesQuery | undefined,
  AdminHeroImagesQueryVariables
>;
export function useAdminHeroImagesSuspenseQuery(
  baseOptions?:
...
export type AdminHeroImagesQueryHookResult = ReturnType<
  typeof useAdminHeroImagesQuery
>;
export type AdminHeroImagesLazyQueryHookResult = ReturnType<
  typeof useAdminHeroImagesLazyQuery
>;
export type AdminHeroImagesSuspenseQueryHookResult = ReturnType<
  typeof useAdminHeroImagesSuspenseQuery
>;
 ...
 * });
 */
export function useAdminContactInfoQuery(
  baseOptions?: ApolloReactHooks.QueryHookOptions<
    AdminContactInfoQuery,
    AdminContactInfoQueryVariables
  >,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return ApolloReactHooks.useQuery<
    AdminContactInfoQuery,
    AdminContactInfoQueryVariables
  >(AdminContactInfoDocument, options);
}
export function useAdminContactInfoLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    AdminContactInfoQuery,
    AdminContactInfoQueryVariables
  >,
...
// @ts-ignore
export function useAdminContactInfoSuspenseQuery(
  baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<
    AdminContactInfoQuery,
    AdminContactInfoQueryVariables
  >,
...
export function useAdminContactInfoSuspenseQuery(
  ...
  AdminContactInfoQuery | undefined,
  AdminContactInfoQueryVariables
>;
export function useAdminContactInfoSuspenseQuery(
  baseOptions?:
...
export type AdminContactInfoQueryHookResult = ReturnType<
  typeof useAdminContactInfoQuery
>;
export type AdminContactInfoLazyQueryHookResult = ReturnType<
  typeof useAdminContactInfoLazyQuery
>;
export type AdminContactInfoSuspenseQueryHookResult = ReturnType<
  typeof useAdminContactInfoSuspenseQuery
>;
...
export function useAdminSocialLinksQuery(
  baseOptions?: ApolloReactHooks.QueryHookOptions<
    ...
    AdminSocialLinksQueryVariables
  >,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return ApolloReactHooks.useQuery<
    AdminSocialLinksQuery,
    AdminSocialLinksQueryVariables
  >(AdminSocialLinksDocument, options);
}
export function useAdminSocialLinksLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    AdminSocialLinksQuery,
    AdminSocialLinksQueryVariables
  >,
...
// @ts-ignore
export function useAdminSocialLinksSuspenseQuery(
  baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<
    AdminSocialLinksQuery,
    AdminSocialLinksQueryVariables
  >,
...
export function useAdminSocialLinksSuspenseQuery(
  ...
  AdminSocialLinksQuery | undefined,
  AdminSocialLinksQueryVariables
>;
export function useAdminSocialLinksSuspenseQuery(
  baseOptions?:
...
export type AdminSocialLinksQueryHookResult = ReturnType<
  typeof useAdminSocialLinksQuery
>;
export type AdminSocialLinksLazyQueryHookResult = ReturnType<
  typeof useAdminSocialLinksLazyQuery
>;
export type AdminSocialLinksSuspenseQueryHookResult = ReturnType<
  typeof useAdminSocialLinksSuspenseQuery
>;
 ...
 * });
 */
export function useAdminGetPresignedUploadUrlMutation(
  baseOptions?: ApolloReactHooks.MutationHookOptions<
  ...
  return ApolloReactHooks.useMutation<
    AdminGetPresignedUploadUrlMutation,
    AdminGetPresignedUploadUrlMutationVariables
  >(AdminGetPresignedUploadUrlDocument, options);
}
export type AdminGetPresignedUploadUrlMutationHookResult = ReturnType<
  typeof useAdminGetPresignedUploadUrlMutation
>;
...
export function useAdminUpdateUserRoleMutation(
  ...
  return ApolloReactHooks.useMutation<
    AdminUpdateUserRoleMutation,
    AdminUpdateUserRoleMutationVariables
  >(AdminUpdateUserRoleDocument, options);
}
export type AdminUpdateUserRoleMutationHookResult = ReturnType<
  typeof useAdminUpdateUserRoleMutation
>;
 ...
 * });
 */
export function useAdminUserByIdQuery(
  baseOptions: ApolloReactHooks.QueryHookOptions<
    AdminUserByIdQuery,
    AdminUserByIdQueryVariables
  > &
    (
      | { variables: AdminUserByIdQueryVariables; skip?: boolean }
      | { skip: boolean }
    ),
) {
  const options = { ...defaultOptions, ...baseOptions };
  return ApolloReactHooks.useQuery<
    AdminUserByIdQuery,
    AdminUserByIdQueryVariables
  >(AdminUserByIdDocument, options);
}
export function useAdminUserByIdLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    AdminUserByIdQuery,
    AdminUserByIdQueryVariables
  >,
...
// @ts-ignore
export function useAdminUserByIdSuspenseQuery(
  baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<
    AdminUserByIdQuery,
    AdminUserByIdQueryVariables
  >,
...
export type AdminUserByIdQueryHookResult = ReturnType<
  typeof useAdminUserByIdQuery
>;
export type AdminUserByIdLazyQueryHookResult = ReturnType<
  typeof useAdminUserByIdLazyQuery
>;
export type AdminUserByIdSuspenseQueryHookResult = ReturnType<
  typeof useAdminUserByIdSuspenseQuery
>;
 ...
 * });
 */
export function useAdminUserOrdersQuery(
  baseOptions: ApolloReactHooks.QueryHookOptions<
    AdminUserOrdersQuery,
    AdminUserOrdersQueryVariables
  > &
    (
      | { variables: AdminUserOrdersQueryVariables; skip?: boolean }
      | { skip: boolean }
    ),
) {
  const options = { ...defaultOptions, ...baseOptions };
  return ApolloReactHooks.useQuery<
    AdminUserOrdersQuery,
    AdminUserOrdersQueryVariables
  >(AdminUserOrdersDocument, options);
}
export function useAdminUserOrdersLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    AdminUserOrdersQuery,
    AdminUserOrdersQueryVariables
  >,
...
// @ts-ignore
export function useAdminUserOrdersSuspenseQuery(
  baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<
    AdminUserOrdersQuery,
    AdminUserOrdersQueryVariables
  >,
...
export function useAdminUserOrdersSuspenseQuery(
  ...
  AdminUserOrdersQuery | undefined,
  AdminUserOrdersQueryVariables
>;
export function useAdminUserOrdersSuspenseQuery(
  baseOptions?:
...
export type AdminUserOrdersQueryHookResult = ReturnType<
  typeof useAdminUserOrdersQuery
>;
export type AdminUserOrdersLazyQueryHookResult = ReturnType<
  typeof useAdminUserOrdersLazyQuery
>;
export type AdminUserOrdersSuspenseQueryHookResult = ReturnType<
  typeof useAdminUserOrdersSuspenseQuery
>;
 ...
 * });
 */
export function useAdminUserRegistrationsQuery(
  baseOptions: ApolloReactHooks.QueryHookOptions<
    AdminUserRegistrationsQuery,
    AdminUserRegistrationsQueryVariables
  > &
    (
      | { variables: AdminUserRegistrationsQueryVariables; skip?: boolean }
      | { skip: boolean }
    ),
) {
  const options = { ...defaultOptions, ...baseOptions };
  return ApolloReactHooks.useQuery<
    AdminUserRegistrationsQuery,
    AdminUserRegistrationsQueryVariables
  >(AdminUserRegistrationsDocument, options);
}
export function useAdminUserRegistrationsLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    AdminUserRegistrationsQuery,
    AdminUserRegistrationsQueryVariables
  >,
...
export function useAdminUserRegistrationsSuspenseQuery(
  ...
  AdminUserRegistrationsQuery | undefined,
  AdminUserRegistrationsQueryVariables
>;
export function useAdminUserRegistrationsSuspenseQuery(
  baseOptions?:
...
export type AdminUserRegistrationsQueryHookResult = ReturnType<
  typeof useAdminUserRegistrationsQuery
>;
export type AdminUserRegistrationsLazyQueryHookResult = ReturnType<
  typeof useAdminUserRegistrationsLazyQuery
>;
export type AdminUserRegistrationsSuspenseQueryHookResult = ReturnType<
  typeof useAdminUserRegistrationsSuspenseQuery
>;
 ...
 * });
 */
export function useAdminUserCartQuery(
  baseOptions: ApolloReactHooks.QueryHookOptions<
    AdminUserCartQuery,
    AdminUserCartQueryVariables
  > &
    (
      | { variables: AdminUserCartQueryVariables; skip?: boolean }
      | { skip: boolean }
    ),
) {
  const options = { ...defaultOptions, ...baseOptions };
  return ApolloReactHooks.useQuery<
    AdminUserCartQuery,
    AdminUserCartQueryVariables
  >(AdminUserCartDocument, options);
}
export function useAdminUserCartLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    AdminUserCartQuery,
    AdminUserCartQueryVariables
  >,
...
// @ts-ignore
export function useAdminUserCartSuspenseQuery(
  baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<
    AdminUserCartQuery,
    AdminUserCartQueryVariables
  >,
...
export type AdminUserCartQueryHookResult = ReturnType<
  typeof useAdminUserCartQuery
>;
export type AdminUserCartLazyQueryHookResult = ReturnType<
  typeof useAdminUserCartLazyQuery
>;
export type AdminUserCartSuspenseQueryHookResult = ReturnType<
  typeof useAdminUserCartSuspenseQuery
>;
 ...
 * });
 */
export function useAdminUserWishlistQuery(
  baseOptions: ApolloReactHooks.QueryHookOptions<
    AdminUserWishlistQuery,
    AdminUserWishlistQueryVariables
  > &
    (
      | { variables: AdminUserWishlistQueryVariables; skip?: boolean }
      | { skip: boolean }
    ),
) {
  const options = { ...defaultOptions, ...baseOptions };
  return ApolloReactHooks.useQuery<
    AdminUserWishlistQuery,
    AdminUserWishlistQueryVariables
  >(AdminUserWishlistDocument, options);
}
export function useAdminUserWishlistLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    AdminUserWishlistQuery,
    AdminUserWishlistQueryVariables
  >,
...
// @ts-ignore
export function useAdminUserWishlistSuspenseQuery(
  baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<
    AdminUserWishlistQuery,
    AdminUserWishlistQueryVariables
  >,
...
export function useAdminUserWishlistSuspenseQuery(
  ...
  AdminUserWishlistQuery | undefined,
  AdminUserWishlistQueryVariables
>;
export function useAdminUserWishlistSuspenseQuery(
  baseOptions?:
...
export type AdminUserWishlistQueryHookResult = ReturnType<
  typeof useAdminUserWishlistQuery
>;
export type AdminUserWishlistLazyQueryHookResult = ReturnType<
  typeof useAdminUserWishlistLazyQuery
>;
export type AdminUserWishlistSuspenseQueryHookResult = ReturnType<
  typeof useAdminUserWishlistSuspenseQuery
>;
...
export function useUpdateCartQuantityMutation(
  ...
  return ApolloReactHooks.useMutation<
    UpdateCartQuantityMutation,
    UpdateCartQuantityMutationVariables
  >(UpdateCartQuantityDocument, options);
}
export type UpdateCartQuantityMutationHookResult = ReturnType<
  typeof useUpdateCartQuantityMutation
>;
...
export function useCartSuspenseQuery(
  baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<
    ...
    CartQueryVariables
  >,
): ApolloReactHooks.UseSuspenseQueryResult<CartQuery, CartQueryVariables>;
export function useCartSuspenseQuery(
  baseOptions?:
    | ApolloReactHooks.SkipToken
    | ApolloReactHooks.SuspenseQueryHookOptions<CartQuery, CartQueryVariables>,
): ApolloReactHooks.UseSuspenseQueryResult<
  CartQuery | undefined,
  CartQueryVariables
>;
export function useCartSuspenseQuery(
  ...
  const options =
    baseOptions === ApolloReactHooks.skipToken
      ? baseOptions
      : { ...defaultOptions, ...baseOptions };
  return ApolloReactHooks.useSuspenseQuery<CartQuery, CartQueryVariables>(
    CartDocument,
    options,
  );
}
...
export function useRegisterForEventMutation(
  ...
  return ApolloReactHooks.useMutation<
    RegisterForEventMutation,
    RegisterForEventMutationVariables
  >(RegisterForEventDocument, options);
}
export type RegisterForEventMutationHookResult = ReturnType<
  typeof useRegisterForEventMutation
>;
...
export function useCancelRegistrationMutation(
  ...
  return ApolloReactHooks.useMutation<
    CancelRegistrationMutation,
    CancelRegistrationMutationVariables
  >(CancelRegistrationDocument, options);
}
export type CancelRegistrationMutationHookResult = ReturnType<
  typeof useCancelRegistrationMutation
>;
...
export function useEventsSuspenseQuery(
  baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<
    ...
    EventsQueryVariables
  >,
): ApolloReactHooks.UseSuspenseQueryResult<EventsQuery, EventsQueryVariables>;
export function useEventsSuspenseQuery(
  baseOptions?:
    | ApolloReactHooks.SkipToken
    | ApolloReactHooks.SuspenseQueryHookOptions<
...
export function useEventsSuspenseQuery(
  ...
  const options =
    baseOptions === ApolloReactHooks.skipToken
      ? baseOptions
      : { ...defaultOptions, ...baseOptions };
  return ApolloReactHooks.useSuspenseQuery<EventsQuery, EventsQueryVariables>(
    EventsDocument,
    options,
  );
}
...
export function useEventBySlugQuery(
  ...
  > &
    (
      | { variables: EventBySlugQueryVariables; skip?: boolean }
      | { skip: boolean }
    ),
) {
  const options = { ...defaultOptions, ...baseOptions };
  return ApolloReactHooks.useQuery<EventBySlugQuery, EventBySlugQueryVariables>(
    EventBySlugDocument,
    options,
  );
}
export function useEventBySlugLazyQuery(
  ...
  return ApolloReactHooks.useLazyQuery<
    EventBySlugQuery,
    EventBySlugQueryVariables
  >(EventBySlugDocument, options);
}
// @ts-ignore
export function useEventBySlugSuspenseQuery(
  baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<
    EventBySlugQuery,
    EventBySlugQueryVariables
  >,
...
export type EventBySlugLazyQueryHookResult = ReturnType<
  typeof useEventBySlugLazyQuery
>;
export type EventBySlugSuspenseQueryHookResult = ReturnType<
  typeof useEventBySlugSuspenseQuery
>;
...
export function useEventByIdQuery(
  ...
  > &
    (
      | { variables: EventByIdQueryVariables; skip?: boolean }
      | { skip: boolean }
    ),
) {
  const options = { ...defaultOptions, ...baseOptions };
  return ApolloReactHooks.useQuery<EventByIdQuery, EventByIdQueryVariables>(
    EventByIdDocument,
    options,
  );
}
export function useEventByIdLazyQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return ApolloReactHooks.useLazyQuery<EventByIdQuery, EventByIdQueryVariables>(
    EventByIdDocument,
    options,
  );
}
// @ts-ignore
export function useEventByIdSuspenseQuery(
  baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<
    EventByIdQuery,
    EventByIdQueryVariables
  >,
...
>;
export type EventByIdSuspenseQueryHookResult = ReturnType<
  typeof useEventByIdSuspenseQuery
>;
...
export function useUpcomingEventsQuery(
  ...
  return ApolloReactHooks.useQuery<
    UpcomingEventsQuery,
    UpcomingEventsQueryVariables
  >(UpcomingEventsDocument, options);
}
...
// @ts-ignore
export function useUpcomingEventsSuspenseQuery(
  baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<
    UpcomingEventsQuery,
    UpcomingEventsQueryVariables
  >,
...
export type UpcomingEventsQueryHookResult = ReturnType<
  typeof useUpcomingEventsQuery
>;
export type UpcomingEventsLazyQueryHookResult = ReturnType<
  typeof useUpcomingEventsLazyQuery
>;
export type UpcomingEventsSuspenseQueryHookResult = ReturnType<
  typeof useUpcomingEventsSuspenseQuery
>;
...
export function usePastEventsQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return ApolloReactHooks.useQuery<PastEventsQuery, PastEventsQueryVariables>(
    PastEventsDocument,
    options,
  );
}
export function usePastEventsLazyQuery(
  ...
  return ApolloReactHooks.useLazyQuery<
    PastEventsQuery,
    PastEventsQueryVariables
  >(PastEventsDocument, options);
}
// @ts-ignore
export function usePastEventsSuspenseQuery(
  baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<
    PastEventsQuery,
    PastEventsQueryVariables
  >,
...
export type PastEventsLazyQueryHookResult = ReturnType<
  typeof usePastEventsLazyQuery
>;
export type PastEventsSuspenseQueryHookResult = ReturnType<
  typeof usePastEventsSuspenseQuery
>;
...
export function useEventWithUserContextQuery(
  ...
  > &
    (
      | { variables: EventWithUserContextQueryVariables; skip?: boolean }
      | { skip: boolean }
    ),
) {
  const options = { ...defaultOptions, ...baseOptions };
  return ApolloReactHooks.useQuery<
    EventWithUserContextQuery,
    EventWithUserContextQueryVariables
  >(EventWithUserContextDocument, options);
}
export function useEventWithUserContextLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    EventWithUserContextQuery,
    EventWithUserContextQueryVariables
  >,
...
// @ts-ignore
export function useEventWithUserContextSuspenseQuery(
  baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<
    EventWithUserContextQuery,
    EventWithUserContextQueryVariables
  >,
...
export function useEventWithUserContextSuspenseQuery(
  ...
  EventWithUserContextQuery | undefined,
  EventWithUserContextQueryVariables
>;
export function useEventWithUserContextSuspenseQuery(
  baseOptions?:
...
export type EventWithUserContextQueryHookResult = ReturnType<
  typeof useEventWithUserContextQuery
>;
export type EventWithUserContextLazyQueryHookResult = ReturnType<
  typeof useEventWithUserContextLazyQuery
>;
export type EventWithUserContextSuspenseQueryHookResult = ReturnType<
  typeof useEventWithUserContextSuspenseQuery
>;
...
export function useUserRegistrationsSuspenseQuery(
  ...
  UserRegistrationsQuery | undefined,
  UserRegistrationsQueryVariables
>;
export function useUserRegistrationsSuspenseQuery(
  baseOptions?:
...
export function useRegistrationByIdQuery(
  ...
  > &
    (
      | { variables: RegistrationByIdQueryVariables; skip?: boolean }
      | { skip: boolean }
    ),
) {
  const options = { ...defaultOptions, ...baseOptions };
  return ApolloReactHooks.useQuery<
    RegistrationByIdQuery,
    RegistrationByIdQueryVariables
  >(RegistrationByIdDocument, options);
}
export function useRegistrationByIdLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    RegistrationByIdQuery,
    RegistrationByIdQueryVariables
  >,
...
// @ts-ignore
export function useRegistrationByIdSuspenseQuery(
  baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<
    RegistrationByIdQuery,
    RegistrationByIdQueryVariables
  >,
...
export function useRegistrationByIdSuspenseQuery(
  ...
  RegistrationByIdQuery | undefined,
  RegistrationByIdQueryVariables
>;
export function useRegistrationByIdSuspenseQuery(
  baseOptions?:
...
export type RegistrationByIdQueryHookResult = ReturnType<
  typeof useRegistrationByIdQuery
>;
export type RegistrationByIdLazyQueryHookResult = ReturnType<
  typeof useRegistrationByIdLazyQuery
>;
export type RegistrationByIdSuspenseQueryHookResult = ReturnType<
  typeof useRegistrationByIdSuspenseQuery
>;
 ...
 * });
 */
export function useUpcomingRegistrationsQuery(
  baseOptions?: ApolloReactHooks.QueryHookOptions<
  ...
  return ApolloReactHooks.useQuery<
    UpcomingRegistrationsQuery,
    UpcomingRegistrationsQueryVariables
  >(UpcomingRegistrationsDocument, options);
}
export function useUpcomingRegistrationsLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    UpcomingRegistrationsQuery,
    UpcomingRegistrationsQueryVariables
  >,
...
// @ts-ignore
export function useUpcomingRegistrationsSuspenseQuery(
  baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<
    UpcomingRegistrationsQuery,
    UpcomingRegistrationsQueryVariables
  >,
...
export function useUpcomingRegistrationsSuspenseQuery(
  ...
  UpcomingRegistrationsQuery | undefined,
  UpcomingRegistrationsQueryVariables
>;
export function useUpcomingRegistrationsSuspenseQuery(
  baseOptions?:
...
export type UpcomingRegistrationsQueryHookResult = ReturnType<
  typeof useUpcomingRegistrationsQuery
>;
export type UpcomingRegistrationsLazyQueryHookResult = ReturnType<
  typeof useUpcomingRegistrationsLazyQuery
>;
export type UpcomingRegistrationsSuspenseQueryHookResult = ReturnType<
  typeof useUpcomingRegistrationsSuspenseQuery
>;
 ...
 * });
 */
export function useCompletedRegistrationsQuery(
  baseOptions?: ApolloReactHooks.QueryHookOptions<
  ...
  return ApolloReactHooks.useQuery<
    CompletedRegistrationsQuery,
    CompletedRegistrationsQueryVariables
  >(CompletedRegistrationsDocument, options);
}
export function useCompletedRegistrationsLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    CompletedRegistrationsQuery,
    CompletedRegistrationsQueryVariables
  >,
...
// @ts-ignore
export function useCompletedRegistrationsSuspenseQuery(
  baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<
    CompletedRegistrationsQuery,
    CompletedRegistrationsQueryVariables
  >,
...
export function useCompletedRegistrationsSuspenseQuery(
  ...
  CompletedRegistrationsQuery | undefined,
  CompletedRegistrationsQueryVariables
>;
export function useCompletedRegistrationsSuspenseQuery(
  baseOptions?:
...
export type CompletedRegistrationsQueryHookResult = ReturnType<
  typeof useCompletedRegistrationsQuery
>;
export type CompletedRegistrationsLazyQueryHookResult = ReturnType<
  typeof useCompletedRegistrationsLazyQuery
>;
export type CompletedRegistrationsSuspenseQueryHookResult = ReturnType<
  typeof useCompletedRegistrationsSuspenseQuery
>;
...
export function useUnsubscribeFromNewsletterMutation(
  ...
  return ApolloReactHooks.useMutation<
    UnsubscribeFromNewsletterMutation,
    UnsubscribeFromNewsletterMutationVariables
  >(UnsubscribeFromNewsletterDocument, options);
}
export type UnsubscribeFromNewsletterMutationHookResult = ReturnType<
  typeof useUnsubscribeFromNewsletterMutation
>;
 ...
 * });
 */
export function useNewsletterStatusQuery(
  baseOptions?: ApolloReactHooks.QueryHookOptions<
    NewsletterStatusQuery,
    NewsletterStatusQueryVariables
  >,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return ApolloReactHooks.useQuery<
    NewsletterStatusQuery,
    NewsletterStatusQueryVariables
  >(NewsletterStatusDocument, options);
}
export function useNewsletterStatusLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    NewsletterStatusQuery,
    NewsletterStatusQueryVariables
  >,
...
// @ts-ignore
export function useNewsletterStatusSuspenseQuery(
  baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<
    NewsletterStatusQuery,
    NewsletterStatusQueryVariables
  >,
...
export function useNewsletterStatusSuspenseQuery(
  ...
  NewsletterStatusQuery | undefined,
  NewsletterStatusQueryVariables
>;
export function useNewsletterStatusSuspenseQuery(
  baseOptions?:
...
export type NewsletterStatusQueryHookResult = ReturnType<
  typeof useNewsletterStatusQuery
>;
export type NewsletterStatusLazyQueryHookResult = ReturnType<
  typeof useNewsletterStatusLazyQuery
>;
export type NewsletterStatusSuspenseQueryHookResult = ReturnType<
  typeof useNewsletterStatusSuspenseQuery
>;
...
export function useOrdersSuspenseQuery(
  baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<
    ...
    OrdersQueryVariables
  >,
): ApolloReactHooks.UseSuspenseQueryResult<OrdersQuery, OrdersQueryVariables>;
export function useOrdersSuspenseQuery(
  baseOptions?:
    | ApolloReactHooks.SkipToken
    | ApolloReactHooks.SuspenseQueryHookOptions<
...
export function useOrdersSuspenseQuery(
  ...
  const options =
    baseOptions === ApolloReactHooks.skipToken
      ? baseOptions
      : { ...defaultOptions, ...baseOptions };
  return ApolloReactHooks.useSuspenseQuery<OrdersQuery, OrdersQueryVariables>(
    OrdersDocument,
    options,
  );
}
...
export type OrdersSuspenseQueryHookResult = ReturnType<
  typeof useOrdersSuspenseQuery
>;
...
export function useOrderSuspenseQuery(
  baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<
    ...
    OrderQueryVariables
  >,
): ApolloReactHooks.UseSuspenseQueryResult<OrderQuery, OrderQueryVariables>;
export function useOrderSuspenseQuery(
  baseOptions?:
    | ApolloReactHooks.SkipToken
    | ApolloReactHooks.SuspenseQueryHookOptions<
...
export function useProductBySlugQuery(
  ...
  > &
    (
      | { variables: ProductBySlugQueryVariables; skip?: boolean }
      | { skip: boolean }
    ),
) {
  const options = { ...defaultOptions, ...baseOptions };
...
export function useBestSellersQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return ApolloReactHooks.useQuery<BestSellersQuery, BestSellersQueryVariables>(
    BestSellersDocument,
    options,
  );
}
export function useBestSellersLazyQuery(
  ...
  return ApolloReactHooks.useLazyQuery<
    BestSellersQuery,
    BestSellersQueryVariables
  >(BestSellersDocument, options);
}
// @ts-ignore
export function useBestSellersSuspenseQuery(
  baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<
    BestSellersQuery,
    BestSellersQueryVariables
  >,
...
export type BestSellersLazyQueryHookResult = ReturnType<
  typeof useBestSellersLazyQuery
>;
export type BestSellersSuspenseQueryHookResult = ReturnType<
  typeof useBestSellersSuspenseQuery
>;
...
export function useRecommendedProductsQuery(
  ...
  return ApolloReactHooks.useQuery<
    RecommendedProductsQuery,
    RecommendedProductsQueryVariables
  >(RecommendedProductsDocument, options);
}
export function useRecommendedProductsLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    RecommendedProductsQuery,
    RecommendedProductsQueryVariables
  >,
...
// @ts-ignore
export function useRecommendedProductsSuspenseQuery(
  baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<
    RecommendedProductsQuery,
    RecommendedProductsQueryVariables
  >,
...
export function useRecommendedProductsSuspenseQuery(
  ...
  RecommendedProductsQuery | undefined,
  RecommendedProductsQueryVariables
>;
export function useRecommendedProductsSuspenseQuery(
  baseOptions?:
...
export type RecommendedProductsQueryHookResult = ReturnType<
  typeof useRecommendedProductsQuery
>;
export type RecommendedProductsLazyQueryHookResult = ReturnType<
  typeof useRecommendedProductsLazyQuery
>;
export type RecommendedProductsSuspenseQueryHookResult = ReturnType<
  typeof useRecommendedProductsSuspenseQuery
>;
...
// @ts-ignore
export function useMaterialsSuspenseQuery(
  baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<
    MaterialsQuery,
    MaterialsQueryVariables
  >,
...
>;
export type MaterialsSuspenseQueryHookResult = ReturnType<
  typeof useMaterialsSuspenseQuery
>;
 ...
 * });
 */
export function useCreateEventReviewMutation(
  baseOptions?: ApolloReactHooks.MutationHookOptions<
  ...
  return ApolloReactHooks.useMutation<
    CreateEventReviewMutation,
    CreateEventReviewMutationVariables
  >(CreateEventReviewDocument, options);
}
export type CreateEventReviewMutationHookResult = ReturnType<
  typeof useCreateEventReviewMutation
>;
...
export function useToggleReviewLikeMutation(
  ...
  return ApolloReactHooks.useMutation<
    ToggleReviewLikeMutation,
    ToggleReviewLikeMutationVariables
  >(ToggleReviewLikeDocument, options);
}
export type ToggleReviewLikeMutationHookResult = ReturnType<
  typeof useToggleReviewLikeMutation
>;
...
export function useEventReviewsQuery(
  ...
  > &
    (
      | { variables: EventReviewsQueryVariables; skip?: boolean }
      | { skip: boolean }
    ),
) {
  const options = { ...defaultOptions, ...baseOptions };
...
// @ts-ignore
export function useEventReviewsSuspenseQuery(
  baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<
    EventReviewsQuery,
    EventReviewsQueryVariables
  >,
...
>;
export type EventReviewsSuspenseQueryHookResult = ReturnType<
  typeof useEventReviewsSuspenseQuery
>;
...
export function useGlobalSearchQuery(
  ...
  > &
    (
      | { variables: GlobalSearchQueryVariables; skip?: boolean }
      | { skip: boolean }
    ),
) {
  const options = { ...defaultOptions, ...baseOptions };
...
// @ts-ignore
export function useGlobalSearchSuspenseQuery(
  baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<
    GlobalSearchQuery,
    GlobalSearchQueryVariables
  >,
...
>;
export type GlobalSearchSuspenseQueryHookResult = ReturnType<
  typeof useGlobalSearchSuspenseQuery
>;
...
export function useUserCountsQuery(
  baseOptions?: ApolloReactHooks.QueryHookOptions<
    UserCountsQuery,
    UserCountsQueryVariables
  >,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return ApolloReactHooks.useQuery<UserCountsQuery, UserCountsQueryVariables>(
    UserCountsDocument,
    options,
  );
}
export function useUserCountsLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    UserCountsQuery,
    UserCountsQueryVariables
  >,
  ...
  return ApolloReactHooks.useLazyQuery<
    UserCountsQuery,
    UserCountsQueryVariables
  >(UserCountsDocument, options);
}
// @ts-ignore
export function useUserCountsSuspenseQuery(
  baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<
    UserCountsQuery,
    UserCountsQueryVariables
  >,
...
export type UserCountsLazyQueryHookResult = ReturnType<
  typeof useUserCountsLazyQuery
>;
export type UserCountsSuspenseQueryHookResult = ReturnType<
  typeof useUserCountsSuspenseQuery
>;
...
export function useAddToWishlistMutation(
  ...
  return ApolloReactHooks.useMutation<
    AddToWishlistMutation,
    AddToWishlistMutationVariables
  >(AddToWishlistDocument, options);
}
export type AddToWishlistMutationHookResult = ReturnType<
  typeof useAddToWishlistMutation
>;
...
export function useRemoveFromWishlistMutation(
  ...
  return ApolloReactHooks.useMutation<
    RemoveFromWishlistMutation,
    RemoveFromWishlistMutationVariables
  >(RemoveFromWishlistDocument, options);
}
export type RemoveFromWishlistMutationHookResult = ReturnType<
  typeof useRemoveFromWishlistMutation
>;
...
export function useToggleWishlistMutation(
  ...
  return ApolloReactHooks.useMutation<
    ToggleWishlistMutation,
    ToggleWishlistMutationVariables
  >(ToggleWishlistDocument, options);
}
export type ToggleWishlistMutationHookResult = ReturnType<
...
export function useMoveToCartMutation(
  ...
  return ApolloReactHooks.useMutation<
    MoveToCartMutation,
    MoveToCartMutationVariables
  >(MoveToCartDocument, options);
}
export type MoveToCartMutationHookResult = ReturnType<
  typeof useMoveToCartMutation
>;
...
export function useWishlistQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return ApolloReactHooks.useQuery<WishlistQuery, WishlistQueryVariables>(
    WishlistDocument,
    options,
  );
}
export function useWishlistLazyQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return ApolloReactHooks.useLazyQuery<WishlistQuery, WishlistQueryVariables>(
    WishlistDocument,
    options,
  );
}
// @ts-ignore
export function useWishlistSuspenseQuery(
  baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<
    WishlistQuery,
    WishlistQueryVariables
  >,
...
>;
export type WishlistSuspenseQueryHookResult = ReturnType<
  typeof useWishlistSuspenseQuery
>;
...
export function useWishlistIdsQuery(
  baseOptions?: ApolloReactHooks.QueryHookOptions<
    WishlistIdsQuery,
    WishlistIdsQueryVariables
  >,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return ApolloReactHooks.useQuery<WishlistIdsQuery, WishlistIdsQueryVariables>(
    WishlistIdsDocument,
    options,
  );
}
export function useWishlistIdsLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    WishlistIdsQuery,
    WishlistIdsQueryVariables
  >,
  ...
  return ApolloReactHooks.useLazyQuery<
    WishlistIdsQuery,
    WishlistIdsQueryVariables
  >(WishlistIdsDocument, options);
}
// @ts-ignore
export function useWishlistIdsSuspenseQuery(
  baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<
    WishlistIdsQuery,
    WishlistIdsQueryVariables
  >,
...
export type WishlistIdsLazyQueryHookResult = ReturnType<
  typeof useWishlistIdsLazyQuery
>;
export type WishlistIdsSuspenseQueryHookResult = ReturnType<
  typeof useWishlistIdsSuspenseQuery
>;
