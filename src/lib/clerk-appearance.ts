...
export const clerkAppearance: Appearance = {
  ...
  elements: {
    ...
    socialButtonsBlockButton:
      "h-11 rounded-lg border-neutral-200 bg-card text-neutral-900 font-medium text-sm hover:bg-neutral-50 hover:border-neutral-300 transition-all",
    ...
    formFieldInput:
      "h-11 rounded-lg border-neutral-200 bg-card text-sm focus:border-primary focus:ring-2 focus:ring-primary/10 transition-all placeholder:text-neutral-400",
    formButtonPrimary:
