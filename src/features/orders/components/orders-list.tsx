...
function OrderCard({ order }: OrderCardProps) {
  ...
  return (
    <Link
      ...
      className="group shadow-soft hover:shadow-card bg-card border-border block rounded-2xl border p-4 transition-all duration-200 hover:-translate-y-1 lg:p-5"
    >
